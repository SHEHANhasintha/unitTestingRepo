...
units['add opration should come out with a number'] = function(){
	...
	mat['float[n]/float'] = function() {assert.equal(lib.add(-1,2.2),1.2)}
	mat['float[n]/float[n]'] = function() {assert.equal(lib.add(-1.2,-2.2),-3.4)}
	...
	mat['float/float[long-n]'] = function() {assert.equal(lib.add(1.2,-2.2786),-1.0786)}
	mat['zero/float[long-n]'] = function() {assert.equal(lib.add(0,-1.564),-1.564)}
	mat['integer[long]/integer[long]'] = function() {assert.equal(lib.add(1546456456453645645364564564563456,56767576576576567567567576567567),false)}
